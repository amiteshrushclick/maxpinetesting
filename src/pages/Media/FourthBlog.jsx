...
// import blog1 from '../../assets/BrijVrinda/6.webp'
// import blog2 from '../../assets/BrijVrinda/1.webp'


import img1 from '../../assets/All_home_imgs/Runway_Air.webp'
import img2 from '../../assets/All_home_imgs/upadate-34.webp'
// import img3 from '../../assets/All_home_imgs/update-05.webp'
// import img4 from '../../assets/All_home_imgs/update-23.webp'
  ...
  return (
    <>
      <SEO
        ...
        description={`Buy approved authority plots near Jewar Airport with <a href="https://www.maxpinegroup.in" target="_blank" rel="noopener noreferrer"><strong>Maxpine Group</strong></a>. Prime location, legal approvals, and great returns—secure your future investment today!`}
        ...
        <div className="max-w-5xl mx-auto px-4 pb-2 -mt-32 relative z-10">
          ...
          <article className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="p-8 md:p-12">
              ...
              <img src={blog.image} alt={blog.title} className="w-full h-full object-cover md:h-[40vh] lg:h-[60vh] mb-5 rounded-2xl object-bottom opacity-60" />
